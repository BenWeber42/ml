...
np.save("data\\train_full_edge", generateFullTrainMatrix())
print("train_full_edge saved")
np.save("data\\test_full_edge", generateFullTestMatrix())
print("test_full_edge saved")
