...
import watersheds_segmentation
import util
...
def onSliderChangePatient(val):
    ...
    volume_watersheds = watersheds_segmentation.watersheds_segmentation(volume.reshape(util.DIMS))
    ...
    slice_0_watersheds = volume_watersheds[x, :, :]
    slice_1_watersheds = volume_watersheds[:, y, :]
    slice_2_watersheds = volume_watersheds[:, :, z]
    ...
    show_slices([[slice_0, slice_1, slice_2],
                 [slice_0_watersheds, slice_1_watersheds, slice_2_watersheds]])
...
slice_0_watersheds = volume_watersheds[xInit, :, :]
slice_1_watersheds = volume_watersheds[:, yInit, :]
slice_2_watersheds = volume_watersheds[:, :, zInit]
